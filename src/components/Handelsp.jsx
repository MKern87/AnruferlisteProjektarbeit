...
const Handelsp = ({ITEMHP, popUp, dHandelspartner,T}) => {
  ...
  return (
    <div onClick={() => {popUp(true); dHandelspartner(ITEMHP); T('B')}} className='w-full grid md:grid-cols-12 grid-cols-3 items-center justify-items-center cursor-pointer py-1'>
