...
const RowColor = ({ITEM, popUp, dTagesbericht}) => {
  ...
  return (
    <div onClick={() => {popUp(true); dTagesbericht(ITEM)}} className={bgColor+ 'md:h-20 h-auto w-full cursor-pointer grid md:grid-cols-[180px_auto_50px_50px_100px_100px_120px_120px_70px_100px_120px_70px] grid-cols-3 items-center justify-items-center'}>
